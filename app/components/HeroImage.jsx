...
export default function HeroImage() {
  ...
  return (
    <div className='relative'>
      ...
      <Image src="/hero/Keyboard_L.png" alt='keyboard' width={300} height={300} className='absolute bottom-40 right-0' ref={keyboardRef} />
      <Image src="/hero/Apple_Watch_Laying_R.png" alt='watch' width={150} height={150} className='absolute bottom-24 right-48 z-10' ref={watchRef} />
      ...
      <Image src="/hero/Airpods_1__R.png" alt='airpods' width={200} height={200} className='absolute top-12 left-20' ref={airpodsRef} />
