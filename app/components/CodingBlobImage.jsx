...
export default function CodingBlobImage() {
  ...
  return (
    <div className='relative mb-16'>
      <Image src="/you/codingBlob.svg" alt='hero' width={500} height={500} className='absolute w-4/5 h-4/5 left-10 top-100 md:w-full md:h-full md:left-0 md:top-0' ref={blobRef} />
